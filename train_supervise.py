...
def main():
    ...
    for ite in range(1, valid_num + 1):
        ...
        train_data, dev_data, test_data = dataset.separate_train_dev_test(data_sub_lit, ite)
        test_data_id = [t['id'] for t in test_data]

        """VOCABULARY"""
        src_vocab, trg_vocab, sos, eos = dataset.prepare_vocab(model_valid_dir, train_data, vocab_size, gpu_id)
